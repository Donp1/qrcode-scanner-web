        ...
        <div className="min-h-screen bg-slate-950 text-white flex">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      ...
                      <h1 className="text-xl font-bold">Lecturer Panel</h1>
                    </div>
          ...
          <aside className="hidden lg:flex w-72 border-r border-white/10 bg-slate-900/60 backdrop-blur-xl p-6 flex-col">
            ...
            >
              ...
              <h1 className="text-2xl font-bold">Lecturer Panel</h1>
            </motion.div>
            ...
            <div className="mt-auto">
              <div className="rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-700 p-5">
                ...
                <p className="text-sm text-indigo-100 leading-relaxed">
                  Manage attendance, students, and analytics for your assigned
                  courses.
                </p>
              </div>
            </div>
            ...
            <header className="sticky top-0 z-30 lg:hidden border-b border-white/10 bg-slate-950/90 backdrop-blur-xl">
              <div className="flex items-center justify-between px-5 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-indigo-400">Smart Attendance</p>

                    <h2 className="font-semibold">Lecturer Panel</h2>
                  </div>
                </div>
